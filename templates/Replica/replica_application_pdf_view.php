...
<style>
    ...
    <table width="100%" border="1">
        <tr><td align="center"><h4>Replica Application Form</h4></td></tr>
    </table>

    <table width="100%" border="1">
        <tr><td align="center" style="padding:5px;"><h4>Application for Replica Serial Number of CA</h4></td></tr>
    </table>

    <table width="100%" border="1">
        <tr><td>Applicant Id. : 120/5/CHN/332 <!--<?php echo $customer_id;?>--></td>
            <td align="right">Date: 27/07/2021 <!--<?php echo $pdf_date;?>--></td>
        </tr>
    </table>
