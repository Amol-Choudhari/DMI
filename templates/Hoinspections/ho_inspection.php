					...
					<?php echo $this->Form->create(); ?>
						<div class="card card-success">
							...
							<?php
								if(
									(
										($export_unit_status == 'yes' && $check_user_role['dy_ama'] == 'yes') ||
										($export_unit_status != 'yes' && $NablDate != null && !empty($check_valid_ro)) || //line added on 30-09-2021
										($_SESSION['application_type'] == 9 && $split_customer_id[1] == 3 && !empty($check_valid_ro)) //This condition is added to show the grant button to RO after AMA approved for lab - Akash [17-08-2023]
									) && !empty($check_ama_approval) && $ca_bevo_applicant != 'yes'
									
								){//applied bevo condition on 24-11-2017
