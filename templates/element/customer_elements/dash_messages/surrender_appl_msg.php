				...
				<?php 
					...
					if ($split_customer_id[1] == 1) {
						...
						echo "Your Application for Surrender is Approved, and this Certificate of Authorisation is cancelled by the competent authority dated <b>" . htmlspecialchars($isSurrender) . "</b>. 
							...
							commodity/ies under AGMARK. If a violation is observed, action shall be taken as per APGM Act and GGM Rule. To see the PDFs , please click on the <span class='cNavy'>Surrender Application</span> tab.";
						...
						"If a violation is observed, action shall be taken as per APGM Act and GGM Rule. To see the PDFs , please click on the <i>Surrender Application</i> tab.";
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="alert alert-success alert-dismissible">
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
				<h5><i class="icon fas fa-info"></i> Please Note !</h5>
				Your Application for Surrender is successfully submitted to AGMARK. To see the application pdf for the surrender, please click on the <i><b>Surrender Application</b></i> tab.
			</div>
		</div>  
	</div>
