<?php echo $this->Form->create(null); ?>
	<div class="container-fluid form-group">
	  		<h5 class="mt-1 mb-2">Applications For E-Code Replica</h5>
			<div class="row">
				<div class="col-md-12">
										...
										if(!empty($replica_appl_list)){
											...
											foreach($replica_appl_list as $each){ ?>
												...
												<tr>
													...
													<td><?php echo $this->Html->link('View Details', array('controller' => 'Ecode', 'action'=>'replica_appl_list_id', $each['ca_unique_no'])); ?></td>
												</tr>
...
<?php echo $this->Html->script('Ecode/replica_appl_list'); ?>
