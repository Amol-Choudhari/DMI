...
<style>
    ...
    <table width="100%" border="1">
        <tr><td align="center"><h4>Replica E-Code Application Form</h4></td></tr>
    </table>

    <table width="100%" border="1">
        <tr><td align="center" style="padding:5px;"><h4>Application for E-Code of CA</h4></td></tr>
    </table>
    ...
    <table  width="100%">
        ...
        <tr>    
            <td><br>Subject: Allotment of E-code for printing AGMARK replica bearing packets request.</td>
        </tr>
        ...
        <tr>
            <td><br>I am submitting and application for the allotment of E-code for printing of AGMARK replica bearing packets required for the commodities as under:-</td>
        </tr>
