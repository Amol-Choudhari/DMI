...
<?php //This Page Used For  Inprocess Renewal Apllication List & Count-Yashwant 06-Mar-2023 ?>
						...
						<div class="bg-transparent">
							<div id="search_by_options" class="">
								<div class="row report-filter pt-2">
									<!-- change parameter RenewalId -> cert_type By shreeya on date [25-05-2023] -->
									<?php if($cert_type!='PP') {?>
									<div class="col-sm-3">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="table-responsive report-table-format">
							<table class="table table-sm rounded" id="pending_renewal_applications_report_table">
								...
								<tbody class="">
									...
									<tr id="table_row" class="row-hover border border-light">
										...
										<td class="text-right"><span class="badge title borderless"><?php echo $user_roles[$i]; ?></span></td>
...
<?php echo $this->Html->script('Reports/pending_renewal_applications_report'); ?>
