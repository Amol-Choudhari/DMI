<?php // 10/Mar/2023 : Add this template in Reports folder,It's required for GRanted Renewal Application (Esigned) For Showing Counts & Record List    - Yashwant ?>
						    ...
						    <div class="bg-transparent">
							    <div id="search_by_options" class="">
								    <div class="row report-filter pt-2">
								    	<!-- change parameter newappId -> cert_type By shreeya on date [25-05-2023] -->
										<?php if($cert_type!='PP') {?>
									    <div class="col-sm-3">
