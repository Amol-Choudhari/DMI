					...
					<div class="px-4 page-header" >
						...
						<div class="bg-transparent">
							<div id="search_by_options" class="">
								...
								<!-- 	<//?php if($cert_type_decode!='2') {?>
									<div class="col-sm-3">
                    					<div class="form-group">
											
											<//?php echo $this->form->input('application_type', array('type'=>'select', 'value'=>$application_type, 'options'=>$application_type_array, 'label'=>false, 'multiple'=>'multiple', 'id'=>'application_type', 'escape'=>false, 'class'=>'form-control form-control-sm search_field')); ?>
									  	</div>
								  	</div>
								  <//?php } ?> -->
									<div class="col-sm-3">
