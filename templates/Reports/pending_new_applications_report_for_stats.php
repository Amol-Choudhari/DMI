				...
				<div class="px-4 page-header">
					...
					<div class="bg-transparent">
						<div id="search_by_options" class="">
							...
							<!-- change parameter newappId -> cert_type By shreeya on date [24-05-2023] -->
							<?php if($cert_type!='PP') {?>	
							<div class="col-sm-3">
						...
						<div class="table-responsive report-table-format">
							<table class="table table-sm rounded" id="pending-new-applications-report-data-table">
								...
								<tr id="table_row" class="row-hover border border-light">
									...
									<td class="text-right"><span class="badge subtitle borderless"><?php echo $user_roles[$i]; ?></span>
									</td>
									<td><span class="badge subtitle borderless"><?php echo $user_office[$i]; ?></span>
									</td>
									<td>
