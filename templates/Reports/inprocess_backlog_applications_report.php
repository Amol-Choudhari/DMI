<?php echo $this->Html->css('Reports/pending_renewal_applications_report') ?>

<?php //This Page Used For  Inprocess - Backlog Apllication List & Count-Yashwant 06-Mar-2023 ?>
<div class="content-wrapper">
	<div class="content-header page-header" id="page-load">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h6 class="m-0 ml-3"><?php echo $report_name; ?></h6>
				</div>
						...
						<div class="bg-transparent">
							<div id="search_by_options" class="">
								<div class="row report-filter pt-2">
									<!-- change parameter BacklogId -> cert_type By shreeya on date [25-05-2023] -->
									<?php if($cert_type!='PP') {?>
									<div class="col-sm-3">
									...
									<!-- <div class="col-sm-3">
                    					<div class="form-group">
											...
											</?php echo $this->form->input('user_role', array('type'=>'select', 'value'=>'','options'=>$user_roles_xy, 'label'=>false, 'id'=>'user_role', 'empty'=>'All', 'escape'=>false, 'class'=>'form-control form-control-sm search_field')); ?>
									  	</div>
								  	</div>
									...
									<div class="col-sm-3" id="office_ro">
                    					<div class="form-group">
											...
											</?php echo $this->form->input('ro_office', array('type'=>'select', 'value'=>'', 'options'=>$ro_office, 'label'=>false, 'multiple'=>'multiple', 'id'=>'office_ro_input',  'escape'=>false, 'class'=>'form-control form-control-sm search_field')); ?>
									  	</div>
								  	</div>
									<div class="col-sm-3" id="office_mo">
                    					<div class="form-group">
											
											</?php echo $this->form->input('mo_office', array('type'=>'select', 'value'=>'', 'options'=>$ro_office, 'label'=>false, 'multiple'=>'multiple', 'id'=>'office_mo_input',  'escape'=>false, 'class'=>'form-control form-control-sm search_field')); ?>
									  	</div>
								  	</div>
									<div class="col-sm-3" id="office_io">
                    					<div class="form-group">
											
											</?php echo $this->form->input('io_office', array('type'=>'select', 'value'=>'', 'options'=>$ro_office, 'label'=>false, 'multiple'=>'multiple', 'id'=>'office_io_input',  'escape'=>false, 'class'=>'form-control form-control-sm search_field')); ?>
									  	</div>
								  	</div> -->
								</div>
					...
					<div class="mx-5">
						<?php ?> <span class="badge bg-light shadow">RESULT</span><i class="fas fa-chevron-right px-2 fs80"></i> <?php
							...
							?>  <span class="badge rounded-pill bg-grad1 shadow">Office</span>
									<i class="fas fa-caret-right"></i>
									<span class="badge bg-grad2 mr-3 shadow"> <?php foreach($ro_office_id as $office) {
							...
							?>  <span class="badge rounded-pill bg-grad1 shadow">Office</span>
									<i class="fas fa-caret-right"></i>
									<span class="badge bg-grad2 mr-3 shadow"> <?php foreach($mo_office_id as $office) {
										echo $ro_office[$office];
									}  $search_value = 'yes'; ?> </span>
								<?php
							}
							...
							?>  <span class="badge rounded-pill bg-grad1 shadow">Office</span>
									<i class="fas fa-caret-right"></i>
									<span class="badge bg-grad2 mr-3 shadow"> <?php foreach($io_office_id as $office) {
										 echo $ro_office[$office];
									}  $search_value = 'yes'; ?> </span>
								<?php
							}
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="table-responsive report-table-format">
							<table class="table table-sm rounded" id="pending_backlog_applications_report_table">
								...
								<tbody class="">
									...
									<tr id="table_row" class="row-hover border border-light">
										...
										<!-- <td class="text-right">
											<span class="badge title borderless"><//?php echo $user_roles[$i]; ?></span>
										</td>
										<td>
											<span class="badge subtitle borderless"><//?php echo $user_office[$i]; ?></span>
										</td>
										<td>
										...
										<td><?php if($date[$i] == null) { echo $date[$i]; } else { ?>
											<span class="badge subtitle borderless"><?php echo $explode_date[1]; } ?></span></td>
									</tr>
									<?php $sr_no++; }
										if(empty($date)) { ?>
									<tr>
...
<?php echo $this->Html->script('Reports/pending_backlog_applications_report'); ?>
