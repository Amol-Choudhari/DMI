...
<style>
    ...
    <table width="100%" border="1">
        <tr><td align="center" style="padding:5px;"><h4>Certificate of Approval & Issue of E-Code</h4></td></tr>
    </table>
    ...
    <table  width="100%">
        ...
        <tr>    
            <td><br>Subject: Approval of application to grant & issue E-code – regarding.</td>
        </tr>
        ...
        <tr>
            <td>With reference to your application dated <?php echo $appl_date; ?> on the subject sited above, 
				it is inform, that you have been granted the Approval to use E-Code numbers, 
				...
				6. Replica serial numbers alloted/issued up to this date fully exhausted before starting the use of E-code.<br>
