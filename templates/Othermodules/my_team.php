                                ...
                                <div class="form-horizontal marginBottom33">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <span class="col-md-3"><label>Office Name : <span id="officeName" class="badge badge-primary"><?php echo $office_name; ?></span></label></span>
                                                    <span class="col-md-3"><label>Office Type : <span id="officeType" class="badge badge-info"><?php echo $office_type; ?></span></label></span>
                                                    <span class="col-md-3"><button id="click_to_show" type="button" class="btn btn-primary">Search By Applicant ID</button></span>
                                                    <span class="col-md-3"><a href="<?php echo $this->getRequest()->getAttribute('webroot');?>Othermodules/get_scenarios"><button id="click_to_show" type="button" class="btn btn-success">View Scenario</button></a></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-10 mt-3 offset-3" id="hide_id">
                                         <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Applicant ID : <span class="cRed">*</span></label>
                                                        <div class="custom-file col-sm-9">
                                                        <?php echo $this->Form->control('search_applicant_id', array('type'=>'text', 'id'=>'search_applicant_id','label'=>false, 'placeholder'=>'Enter Applicant ID Here','class'=>'form-control','required'=>true)); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
