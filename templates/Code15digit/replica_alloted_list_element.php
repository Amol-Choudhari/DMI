<?php echo $this->Html->css('Code15digit/replica_alloted_list_element') ?>
<?php echo $this->Form->create(); ?>
    <div class="replica_details_mod form-group">
        ...
        <button id="replica_details_btn" class="btn btn-primary">Get 15 Digit Code Details</button>
    ...
    <div class="card card-info">
        <div class="card-header"><h3 class="card-title-new">Alloted 15 Digit Code Status</h3></div>
...
<?php echo $this->Html->script('Code15digit/replica_alloted_list_element'); ?>
