    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            optionsWrap.on( 'click', 'input[type="checkbox"]', function(){
                ...
                instance._updateSelectAllText();
                instance._updatePlaceholderText();  //uncomment for showing update placeholder value after select checkbox (By pravin 18/11/2017)
            });
        ...
        _updatePlaceholderText: function(){
			...
			// Change the conndition > to >= for display selected value count on place holder (by pravin 18/11/2017)
