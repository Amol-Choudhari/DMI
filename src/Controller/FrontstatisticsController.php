...
use Cake\View\ViewBuilder;
	...
	class FrontStatisticsController extends AppController{
		...
		public function aqcmsStatistics(){
			...
			$total_payment_transaction = count($newApplicationrevenueTrans) + count($renewalApplicationrevenueTrans) +count($advApplicationrevenueTrans);
