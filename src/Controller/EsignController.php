	...
	public function requestEsign() { 
		...
		//	$esign_status = 1;
			...
			//added this else part on 11-06-2019 by Amol to show esign failed message	
				...
				$this->redirect('https://agmarkonline.dmi.gov.in/DMI/esign/esign_issue');//updated on 31-05-2021 for Form Based Esign method by Amol
			}
...
//below methods are used to Authenticate Aadhar of user/Applicant.	
	...
	public function createEsignXmlAjax(){
		...
		$response_url = 'https://agmarkonline.dmi.gov.in/DMI/esign/'.$response_action;
...
public function renewalRequestReEsign(){ 
		...
		//	$esign_status = 1;	
			...
			$main_domain_url = 'https://agmarkonline.dmi.gov.in/DMI/';
	...
	public function replicaAllotEsign(){ 
		...
		//	$esign_status = 1;
			...
			//by Amol to show esign failed message	
				...
				$this->redirect('https://agmarkonline.dmi.gov.in/DMI/esign/esign_issue');//for Form Based Esign method by Amol
			}
